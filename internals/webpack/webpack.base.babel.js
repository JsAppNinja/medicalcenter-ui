...
// requiring config for define plugin
  ...
  plugins: options.plugins.concat([
    ...
    new webpack.DefinePlugin({
      'process.env': {
        ...
        HELCIM_TOKEN: JSON.stringify(process.env.HELCIM_TOKEN),
        ...
        FIREBASE_MESSAGESENDERID: JSON.stringify(process.env.FIREBASE_MESSAGESENDERID),
      },
    }),
